...
Implement an ApproximateSearchAgent in searchAgents.py that finds a short path through the bigSearch layout. If your agent finds a solution of cost at most 290 receive you 1 point extra credit. If the cost is at most 280 you receive 2 points extra credit. The three individuals that find the shortest path using no more than 30 seconds of computation will receive an in-class demonstration of their brilliant Pacman agents.
...
Zip only the files you altered for this assignment as a .zip and submit it on TSquare before the due date. If you submit it as antything other than a .zip file, then we might not be able to grade it. You have a strict one hour window after the due date to handle any last minute technical issues, after which you will not be able to submit and receive a 0 for the project.
